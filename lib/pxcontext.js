...
class PxContext {
    constructor(config, request, pxLogger) {
        ...
        this.cookies = {};
        this.score = 0;
        this.ip = pxUtil.extractIP(config, request, pxLogger);

        this.headers = pxUtil.filterSensitiveHeaders(request.headers, config.SENSITIVE_HEADERS);
