...
class PxEnforcer {
    ...
    isTelemetryCommand(req) {
        ...
        let headerVal = req.headers[this._config.TELEMETRY_COMMAND_HEADER];
        ...
        //base 64 decode
        let decodedString = Buffer.from(headerVal, 'base64').toString();

        //value is in the form of timestamp:hmac_val
        let splittedValue = decodedString.split(':');
        ...
        //timestamp
        let expirationTime = Number(splittedValue[0]);
