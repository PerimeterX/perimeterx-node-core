...
class PxEnforcer {
    ...
    handleVerification(ctx, req, res, cb) {
        ...
        this.generateResponse(ctx, isJsonResponse, function(responseObject) {
            ...
            if (pxCors.isCorsRequest(req, config)) {
                response.headers = pxCors.setCorsBlockHeaders(req, config, ctx);
            }
            ...
            if (isJsonResponse) {
                response.headers = Object.assign(response.headers || {}, { 'Content-Type': 'application/json' });
            ...
            response.headers = Object.assign(response.headers || {}, { 'Content-Type': 'text/html' });
