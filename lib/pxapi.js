...
function buildRequestData(ctx, config) {
    ...
    data.additional['start_enforcer_timestamp'] = ctx.startEnforcerTime;
    ctx.sendingRiskTimestamp = Date.now();
    data.additional['sending_risk_timestamp'] = ctx.sendingRiskTimestamp;
