...
function filterConfig(config) {
    ...
    delete configCopy.COOKIE_SECRET_KEY;
    delete configCopy.AUTH_TOKEN;
    delete configCopy.MODULE_VERSION;
    delete configCopy.SERVER_HOST;
    delete configCopy.CONFIGURATIONS_HOST;
    delete configCopy.SERVER_TO_SERVER_API_URI;
    delete configCopy.SERVER_CAPTCHA_URI;
    delete configCopy.SERVER_COLLECT_URI;
    delete configCopy.CONFIGURATIONS_URI;
    delete configCopy.TELEMETRY_URI;
    delete configCopy.COOKIE_ENCRYPTION;
    delete configCopy.CE_KEYLEN;
    delete configCopy.CE_IVLEN;
    delete configCopy.CE_ITERATIONS;
    delete configCopy.CE_DIGEST;
    delete configCopy.CE_ALGO;
    delete configCopy.STATIC_FILES_EXT;
    delete configCopy.SCORE_EVALUATE_ACTION;
    delete configCopy.PASS_REASON;
    delete configCopy.MONITOR_MODE;
    return configCopy;
}
