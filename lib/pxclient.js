...
class PxClient {
    ...
    addAdditionalFieldsToActivity(details, ctx) {
        ...
        if (ctx.graphqlData) {
            ...
            details[GQL_OPERATION_TYPE_FIELD] = ctx.graphqlData[0] && ctx.graphqlData[0].operationType;
            details[GQL_OPERATION_NAME_FIELD] = ctx.graphqlData[0] && ctx.graphqlData[0].operationName;
        }
    }
