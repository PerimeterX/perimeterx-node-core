...
const { CI_VERSION_FIELD, CI_SSO_STEP_FIELD, CI_RAW_USERNAME_FIELD, CI_CREDENTIALS_COMPROMISED_FIELD } = require('./utils/constants')
...
class PxClient {
    ...
    generateAdditionalS2SActivity(ctx, config, additionalDetails = {}) {
        ...
        if (!config.SEND_RAW_USERNAME_ON_ADDITIONAL_ACTIVITY || !details.credentials_compromised) {
