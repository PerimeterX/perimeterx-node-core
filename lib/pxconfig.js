...
class PxConfig {
    ...
    static configurationsOverriding(conf, params, defaultName, userInput) {
        ...
        if (
            userInput === 'getUserIp' ||
            userInput === 'additionalActivityHandler' ||
            userInput === 'customRequestHandler' ||
            userInput === 'enrichCustomParameters'
        ) {
        ...
        /* handling jsRef and cssRef */
        if (userInput === 'jsRef' || userInput === 'cssRef') {
...
const configSchemaMapper = {
    px_module_enabled: 'px_module_enabled',
    px_app_id: 'px_app_id',
    px_cookie_secret: 'px_cookie_secret',
    px_auth_token: 'px_auth_token',
    px_proxy_url: 'px_proxy_url',
    px_s2s_timeout: 'px_s2s_timeout',
    px_batch_activities_timeout_ms: 'px_batch_activities_timeout_ms',
    px_custom_request_handler: 'px_custom_request_handler',
    px_extract_user_ip: 'px_extract_user_ip',
    px_blocking_score: 'px_blocking_score',
    px_ip_headers: 'px_ip_headers',
    px_send_async_activities_enabled: 'px_send_async_activities_enabled',
    px_sensitive_headers: 'px_sensitive_headers',
    px_logger_severity: 'px_logger_severity',
    px_max_activity_batch_size: 'px_max_activity_batch_size',
    px_js_ref: 'px_js_ref',
    px_css_ref: 'px_css_ref',
    px_custom_logo: 'px_custom_logo',
    px_sensitive_routes: 'px_sensitive_routes',
    px_filter_by_route: 'px_filter_by_route',
    px_enforced_routes: 'px_enforced_routes',
    px_monitored_routes: 'px_monitored_routes',
    px_dynamic_configuration_enabled: 'px_dynamic_configuration_enabled',
    px_module_mode: 'px_module_mode',
    px_first_party_enabled: 'px_first_party_enabled',
    px_additional_activity_handler: 'px_additional_activity_handler',
    px_enrich_custom_parameters: 'px_enrich_custom_parameters',
    px_testing_mode_enabled: 'px_testing_mode_enabled',
    px_filter_by_extension: 'px_filter_by_extension',
    px_bypass_monitor_header: 'px_bypass_monitor_header',
    px_advanced_blocking_response_enabled: 'px_advanced_blocking_response_enabled',
    px_telemetry_header: 'px_telemetry_header',
    px_custom_template_root: 'px_custom_template_root',
    px_custom_template_data: 'px_custom_template_data',
    px_filter_by_ip: 'px_filter_by_ip',
    px_filter_by_user_agent: 'px_filter_by_user_agent',
    px_filter_by_http_method: 'px_filter_by_http_method',
    px_external_activities_enabled: 'px_external_activities_enabled',
    px_pxhd_secure_enabled: 'px_pxhd_secure_enabled',
    px_backend_url: 'px_backend_url',
    px_custom_cookie_header: 'px_custom_cookie_header',
    px_login_credentials_extraction_enabled: 'px_login_credentials_extraction_enabled',
    px_login_credentials_extraction: 'px_login_credentials_extraction',
};
