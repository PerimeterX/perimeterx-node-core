...
class PxConfig {
    constructor(params, logger) {
        ...
        this.logger = logger;
        this.logger.setCustomLogger(params.customLogger);
    ...
    mergeParams(params) {
        ...
        const configKeyMapping = [['ENABLE_MODULE', 'enableModule'], ['PX_APP_ID', 'pxAppId'], ['COOKIE_SECRET_KEY', 'cookieSecretKey'], ['AUTH_TOKEN', 'authToken'], ['PROXY_URL', 'proxy'],
            ['API_TIMEOUT_MS', 'apiTimeoutMS'], ['ACTIVITIES_TIMEOUT_MS', 'activitiesTimeout'], ['CUSTOM_REQUEST_HANDLER', 'customRequestHandler'], ['GET_USER_IP', 'getUserIp'], ['BLOCKING_SCORE', 'blockingScore'], ['IP_HEADERS', 'ipHeaders'],
            ...
            ['EXTERNAL_ACTIVITIES', 'externalActivities'], ['PXHD_SECURE', 'pxhdSecure'], ['CUSTOM_LOGGER', 'customLogger']];
