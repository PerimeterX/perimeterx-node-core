...
class PxConfig {
    ...
    mergeParams(params) {
        ...
        const configKeyMapping = [
            ...
            ['SEND_RAW_USERNAME_ON_ADDITIONAL_ACTIVITY', 'px_send_raw_username_on_additional_activity'],
            ['AUTOMATIC_ADDITIONAL_ACTIVITY', 'px_automatic_additional_activity_enabled'],
...
function pxDefaultConfig() {
    return {
        ...
        SEND_RAW_USERNAME_ON_ADDITIONAL_ACTIVITY: false,
        AUTOMATIC_ADDITIONAL_ACTIVITY: true,
...
const allowedConfigKeys = [
    ...
    'px_additional_activity_header_enabled',
    'px_send_raw_username_on_additional_activity',
    'px_automatic_additional_activity_enabled',
