...
class PxConfig {
    ...
    mergeParams(params) {
        ...
        if(this.PX_DEFAULT.BACKEND_URL === '') {
            this.PX_DEFAULT.BACKEND_URL = this.PX_DEFAULT.PX_APP_ID !== 'PX_APP_ID' ? this.PX_DEFAULT.BACKEND_URL = 'https://sapi-' + this.PX_DEFAULT.PX_APP_ID.toLowerCase() + '.perimeterx.net' : 'https://sapi.perimeterx.net';
        }
