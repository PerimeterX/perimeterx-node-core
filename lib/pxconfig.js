...
const configSchemaMapper = {
    ...
    px_filter_by_http_method: 'filterByMethod',
    px_filter_by_ip: 'filterByIP',
    px_filter_by_user_agent: 'filterByUserAgent',
    px_sensitive_routes: 'sensitiveRoutes',
    px_enforced_routes: 'enforcedRoutes',
    ...
    px_login_credentials_extraction_enabled: 'enableLoginCredsExtraction',
    px_login_credentials_extraction: 'loginCredsExtraction',
};
