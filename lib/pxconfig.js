...
PX_INTERNAL.CLIENT_HOST = 'client-stg.perimeterx.net';
...
PX_DEFAULT.TEMPLATE = 'recaptcha';
PX_DEFAULT.CAPTCHA_PROVIDER = 'reCaptcha';
...
PX_DEFAULT.FIRST_PARTY_ENABLED = false;
...
class PxConfig {
    ...
    static mergeDefaults(params) {
        ...
        PX_INTERNAL.SERVER_HOST = PX_DEFAULT.PX_APP_ID !== 'PX_APP_ID' ? PX_INTERNAL.SERVER_HOST = 'sapi-' + PX_DEFAULT.PX_APP_ID.toLowerCase() + '.perimeterx.net' : 'https://sapi.perimeterx.net';
        PX_INTERNAL.COLLECTOR_HOST = PX_DEFAULT.PX_APP_ID !== 'PX_APP_ID' ? PX_INTERNAL.COLLECTOR_HOST = 'collector-' + PX_DEFAULT.PX_APP_ID.toLowerCase() + '.perimeterx.net' : 'https://collector.perimeterx.net';
        ...
        PX_DEFAULT.CAPTCHA_PROVIDER = this.configurationsOverriding(PX_DEFAULT, params, "CAPTCHA_PROVIDER", "captchaProvider");
